    ...
    public class ObatDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Obat>(entity =>
            {
                ...
                entity.Property(e => e.Nama).HasColumnName("nama").HasColumnType("VARCHAR(255)");
                ...
                entity.Property(e => e.ExpiredDate).HasColumnName("expired_date").HasColumnType("DATETIME");
            ...
            modelBuilder.Entity<Transaksi>(entity =>
            {
                ...
                entity.Property(e => e.NominalDiskon).HasColumnName("nominal_diskon").HasPrecision(18, 2);
                entity.Property(e => e.PersentasePajak).HasColumnName("persentase_pajak").HasPrecision(5, 2);
                entity.Property(e => e.NominalPajak).HasColumnName("nominal_pajak").HasPrecision(18, 2);
                entity.Property(e => e.TotalAkhir).HasColumnName("total_akhir").HasPrecision(18, 2);
                
                entity.Property(e => e.UangBayar).HasColumnName("uang_bayar").HasPrecision(18, 2);
                entity.Property(e => e.UangKembalian).HasColumnName("uang_kembalian").HasPrecision(18, 2);
                ...
                entity.HasIndex(e => e.NoStruk).IsUnique().HasDatabaseName("idx_transaksi_no_struk");
            ...
            modelBuilder.Entity<TransaksiDetail>(entity =>
            {
                ...
                entity.Property(e => e.TransaksiDetailId).HasColumnName("transaksi_detail_id");
                entity.Property(e => e.TransaksiId).HasColumnName("transaksi_id");
                entity.Property(e => e.ObatId).HasColumnName("obat_id");
